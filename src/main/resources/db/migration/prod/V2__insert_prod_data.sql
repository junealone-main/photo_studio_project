...
INSERT INTO photographers (id, name, surname, description, price, photo_path) VALUES
    (gen_random_uuid(), 'Пётр', 'Чайковский', 'Мастер классического стиля, умеющий передать истинную глубину и драматизм человеческой души в одном кадре. Его работы — это безупречная симфония света и тени, где каждая деталь выверена до совершенства, а результат всегда остаётся вне времени.', 50000, '/images/placeholder.png'),
    (gen_random_uuid(), 'Ханс', 'Циммер', 'Фотограф, превращающий любую съёмку в эпический блокбастер мирового масштаба. Он работает со сложным технологичным светом и огромным пространством, создавая кадры с мощным кинематографическим эффектом, которые хочется рассматривать как кадры из кино.', 70000, '/images/placeholder.png'),
    (gen_random_uuid(), 'Антонио', 'Вивальди', 'Творец, который чувствует ритм модели так же тонко, как движение смычка по струнам. Его стиль — это невероятная динамика, страсть и молниеносная смена образов, превращающая процесс съёмки в яркий вихрь эмоций, где каждый кадр звучит по-новому.', 90000, '/images/placeholder.png'),
    (gen_random_uuid(), 'Рихард', 'Вагнер', 'Если вам нужна монументальность и мощная драма, Рихард — ваш идеальный выбор. Его работы пропитаны тяжёлой эстетикой, контрастным светом и невероятным величием, превращающим обычный портрет в эпическое полотно, наполненное внутренней силой.', 60000, '/images/placeholder.png'),
    (gen_random_uuid(), 'Клод', 'Дебюсси', 'Мастер визуального импрессионизма, работающий с воздухом и тончайшими нюансами кадра. Он создаёт мягкие, словно текучие снимки, наполненные мечтательной атмосферой, где границы реальности размываются, уступая место чистому настроению.', 100000, '/images/placeholder.png'),
    ...
    (gen_random_uuid(), 'Канеки', 'Кен', 'Фотограф с особым взглядом на тёмную эстетику и сложный психологический портрет. Он виртуозно работает с глубокими тенями, скрытыми смыслами и острым контрастом, превращая внутреннюю борьбу и хрупкость момента в захватывающее визуальное искусство.', 65000, '/images/placeholder.png');
