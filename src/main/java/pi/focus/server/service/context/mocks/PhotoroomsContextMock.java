...
public class PhotoroomsContextMock implements IPhotoroomsContext {
    ...
    public PhotoroomsContextMock() {
        photorooms = List.of(
            new DataCardDto("КРУТОЙ Зал 1", "Крутое описание зала 1", MocksDefines.TEST_IMAGE_PATH, "/photorooms/1"),
            new DataCardDto("ОФИГЕННЫЙ Зал 2", "Офигенное описание зала 2", MocksDefines.TEST_IMAGE_PATH, "/photorooms/2"),
            new DataCardDto("милый Зал 3", "Милое описание зала 3", MocksDefines.TEST_IMAGE_PATH, "/photorooms/3")
        );
    }
